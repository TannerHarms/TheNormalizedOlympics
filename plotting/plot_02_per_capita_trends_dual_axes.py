"""
Plot medals per capita trends over time with dual y-axes.
...
def plot_per_capita_trends_dual():
    """Create line plots showing per capita medal trends with dual y-axes."""
    ...
    for season, df in [('Summer', summer_df), ('Winter', winter_df)]:
        ...
        ax.set_ylabel('Top Performers - Medals per Million People', fontsize=16, weight='bold')
        ax2.set_ylabel('Bottom Performers - Medals per Million People', fontsize=16, weight='bold')
        ax.set_title(
            f"Top & Bottom {TOP_N_COUNTRIES} Countries: Medals per Capita Over Time\n"
        ...
        # Save plot
        filename = f'{season.lower()}_per_capita_trends_dual_axes_{TOP_N_COUNTRIES}.png'
