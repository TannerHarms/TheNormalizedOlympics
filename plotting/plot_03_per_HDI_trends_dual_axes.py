"""
Plot medals per HDI trends over time with dual y-axes.
...
def plot_per_hdi_trends_dual():
    """Create line plots showing per HDI medal trends with dual y-axes."""
    ...
    for season, df in [('Summer', summer_df), ('Winter', winter_df)]:
        ...
        for idx, country in enumerate(top_countries):
            ...
            if len(country_data) > 0:
                ...
                top_labels.append(f'{country}: {avg_val:.3f}')
        ...
        for idx, country in enumerate(bottom_countries):
            ...
            if len(country_data) > 0:
                ...
                bottom_labels.append(f'{country}: {avg_val:.3f}')
        ...
        ax.set_ylabel('Top Performers - Medals per HDI Point', fontsize=16, weight='bold')
        ax2.set_ylabel('Bottom Performers - Medals per HDI Point', fontsize=16, weight='bold')
        ax.set_title(
        ...
        # Save plot
        filename = f'{season.lower()}_per_HDI_trends_dual_axes_{TOP_N_COUNTRIES}.png'
